...
protected:
    ...
    bool bypass_gesture_ = false;  // When true, skip gesture detection and let LVGL handle touches
...
public:
    ...
    virtual void SetBypassGesture(bool bypass);  // Set to true when menu is visible
