...
class XiaozhiAIIoTEs3n28p : public WifiBoard {
 private:
  ...
  void InitAnalogClock() {
    ...
    // Create analog clock centered on screen
    int diameter = std::min(DISPLAY_WIDTH, DISPLAY_HEIGHT) - 20;
    int x = (DISPLAY_WIDTH - diameter) / 2;
    int y = (DISPLAY_HEIGHT - diameter) / 2;
