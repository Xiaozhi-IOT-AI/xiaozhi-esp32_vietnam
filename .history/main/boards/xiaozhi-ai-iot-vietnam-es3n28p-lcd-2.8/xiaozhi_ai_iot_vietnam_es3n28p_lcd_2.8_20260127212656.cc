 ...
 private:
  ...
  void InitializeMenu() {
    ...
    menu_ui_->SetCallback(MENU_ACTION_CLOCK, [](void* data) {
      ...
      board->GetDisplay()->SetChatMessage("system", "Đang hiển thị đồng hồ...");
    }, this);
    ...
    menu_ui_->SetCallback(MENU_ACTION_RADIO, [](void* data) {
      ...
      auto* board = static_cast<XiaozhiAIIoTEs3n28p*>(data);
      board->HideMenu();
      board->GetDisplay()->ShowNotification("Radio coming soon!");
    }, this);
    ...
    menu_ui_->SetCallback(MENU_ACTION_LUNAR, [](void* data) {
      ...
      auto* board = static_cast<XiaozhiAIIoTEs3n28p*>(data);
      board->HideMenu();
      board->GetDisplay()->SetChatMessage("system", "Âm lịch Việt Nam");
    }, this);
    ...
    menu_ui_->SetCallback(MENU_ACTION_INFO, [](void* data) {
      ...
      auto* board = static_cast<XiaozhiAIIoTEs3n28p*>(data);
      board->HideMenu();
      board->GetDisplay()->ShowNotification("Xiaozhi AI Vietnam v1.0");
    }, this);
