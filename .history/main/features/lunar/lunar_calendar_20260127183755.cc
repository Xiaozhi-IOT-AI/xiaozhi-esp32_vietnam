...
void LunarCalendar::CreateUI() {
    ...
    lv_obj_set_style_text_font(solar_date_label_, &lv_font_montserrat_20, 0);
    ...
    lv_obj_set_style_text_font(weather_icon_, &lv_font_montserrat_22, 0);
    ...
    lv_obj_set_style_text_font(temp_label_, &lv_font_montserrat_22, 0);
    ...
    lv_obj_set_style_text_font(hour_can_chi_label_, &lv_font_montserrat_14, 0);
    ...
    lv_obj_set_style_text_font(lunar_date_label_, &lv_font_montserrat_20, 0);
    ...
    lv_obj_set_style_text_font(year_can_chi_label_, &lv_font_montserrat_14, 0);
