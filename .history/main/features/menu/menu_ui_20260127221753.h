...
public:
    ...
    // Direct touch handling (bypass LVGL events)
...
private:
    ...
    int GetButtonAtPoint(int16_t x, int16_t y);
    ...
    // Button positions for direct touch handling
    struct ButtonRect {
        int16_t x, y, w, h;
    } button_rects_[MENU_ACTION_COUNT];
